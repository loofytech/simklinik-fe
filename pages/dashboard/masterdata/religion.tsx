...
export default function Religion() {
  ...
  const columns: ColumnsType<DataType> = [
    ...
    {title: 'NAMA', dataIndex: 'religion_name', className: "w-8/12", sorter: false, render: (value, record) => {
      return `${value}`;
    }},
  ...
  return (<AppLayout>
    <div className="bg-white">
      <div className="p-3">
        <button className="px-4 py-2 bg-primary text-white rounded text-sm" type="button" onClick={() => setModalCreate(true)}>Tambah Kepercayaan</button>
      </div>
      <Table
        bordered
        columns={columns}
