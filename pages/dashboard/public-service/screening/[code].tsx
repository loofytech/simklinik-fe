    ...
    <Card title="Data Pasien" className="mb-5">
      <div className="grid grid-cols-6 gap-3">
        <div className="border-b pb-1">
          <div>Nama Pasien</div>
          <div className="mt-2 font-semibold text-lg">{data?.patient.patient_name}</div>
        </div>
        <div className="border-b pb-1">
          <div>Usia</div>
          <div className="mt-2 font-semibold text-lg">{calculateAge(data?.patient.birth_date)} Tahun</div>
        </div>
        <div className="border-b pb-1">
          <div>Jenis Kelamin</div>
          <div className="mt-2 font-semibold text-lg">{data?.patient.patient_gender == "L" ? "Laki - Laki" : "Perempuan"}</div>
        </div>
        <div className="border-b pb-1">
          <div>Nomor Rekam Medis</div>
          <div className="mt-2 font-semibold text-lg">{data?.patient.medical_record}</div>
        </div>
        <div className="border-b pb-1">
          <div>Dokter</div>
